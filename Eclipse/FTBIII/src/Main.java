...
public class Main {
	...
	public static boolean dispComm = true;
	...
	public static void buttonsVerifications() {
		
		for(Level l : levels) {
			
			System.out.println("\n/tp @p " + l.spawn);
			l.buttonsVerifications();
	...
	public static void createLevels() {
		...
		new Level(new Vector(-58, 30, -45), 2, "Color Resistors", 1);                       //Blanco 
		new Level(new Vector(-118, 13, -19), 2, "Fiery Dome", 2);							//Fuego
		new Level(new Vector(-152, 15, -46), 3, "Subnautical Anchors", 3);					//Agua
		new Level(new Vector(-204, 10, -44), 2, "Acorn Pantry", 4);							//Tierra
		new Level(new Vector(-272, 41, -28), 4, "Sunburnt Barn", 5);						//Granja
		new Level(new Vector(-324, 25, -38), 2, "Neon Reactor", 6);							//Verde
		new Level(new Vector(-377, 30, -36), 3, "Pixie Puffland", 7);						//Castillo nubes
		new Level(new Vector(-441, 13, -32), 2, "Button Toll", 8);							//Campanario
		new Level(new Vector(-488, 46, -31), 3, "Bit Omen of Buttons", 9);					//Petroleo
		new Level(new Vector(-545, 57, -32), 5, "Button Unknown Playgrounds", 10);			//Lego
		new Level(new Vector(-593, 49, -40), 2, "Buttons & Buffoons", 11);					//Circo
		new Level(new Vector(-664, 72, -42), 3, "Bottombarrel Alehouse", 12);				//Villa
		new Level(new Vector(-719, 72, -39), 3, "McButton's Goldenpot", 13);				//Arcoiris
		new Level(new Vector(-822, 82, -36), 3, "Delight Concentration", 14);				//Paneles
		new Level(new Vector(-886, 40, -19), 6, "Button Adagio in B minor", 15);			//Caja musical
		new Level(new Vector(-956, 40, -20), 3, "Button Drawers", 16);						//Nevera
		new Level(new Vector(-1046, 48, -5794), 3, "Dental Troubleshooting", 17);			//Zoo 			should be Boca
		new Level(new Vector(-1045, 72, -16), 4, "Zoom Inn", 18);							//Casa blanca 	should be Zoo
		new Level(new Vector(-1148, 75, -15), 4, "Nucular Button Forum", 19);  				//Contenedores 	should be casa blanca
		new Level(new Vector(-1290, 53, -14), 7, "Buttressed Warehouse", 20, new Vector(-1260, 53, -14)); 			//Nido			should be contenedores
		new Level(new Vector(-1371, 57, -12), 2, "Buttonquail's Eggernesst", 21, new Vector(-1371, 57, -30));		//Purpura		should be nido
		new Level(new Vector(-1481, 52, -45), 4, "Purple Motif", 22);												//Pantano		should be purpura
		new Level(new Vector(-1507, 85, -44), 3, "Whirlpurpure Bayou", 23);											//Alien			should be pantano
		new Level(new Vector(-1638, 87, -48), 3, "Buttolon III", 24);												//Cascadas		should be alien
		new Level(new Vector(-1713, 13, -33), 7, "Chessboard Checkmate", 25, new Vector(-1760, 13, -33));			//Ajedrez		
		new Level(new Vector(-1749, 99, -25), 4, "Switched Rapids", 26, new Vector(-1775, 99, -25));				//Boca			should be cascadas
		new Level(new Vector(-1877, 124, -6), 3, "Wicker Still-Life", 27);									//Frutas
		new Level(new Vector(-1971, 92, -37), 3, "Glowmoth Cocoon", 28, new Vector(-1971, 92, -10));		//Cocoon
		new Level(new Vector(-2042, 84, -14), 5, "Crystal Grotto", 29, new Vector(-2075, 84, -14));			//Cristal
		new Level(new Vector(-2198, 108, 31), 8, "The Observants", 30, specialBounds(30, true), specialBounds(30, false)); 	//Ojos
		new Level(new Vector(-2330, 97, 16), 5, "Power Core", 31, new Vector(-2330, 97, -16));								//Mina
		new Level(new Vector(-2462, 145, -11), 4, "Serpentine Stairwell", 32, new Vector(-2486, 145, -11));					//Serpientes
		new Level(new Vector(-2615, 141, -2), 7, "Buttoncell Accumulator", 33, specialBounds(33, true), specialBounds(33, false)); 	//Industrial
		new Level(new Vector(-2886, 176, -4), 6, "Savannah Safari", 34, new Vector(-2845, 176, -4));								//Safari
		new Level(new Vector(-3546, 58, 53), 10, "Gates to the Cosmohedron", 35, specialBounds(35, true), specialBounds(35, false));//Portal
	...
	public static void createButtons() {
		...
		//Level 18
		levels.get(17).addButton(new Button(new Vector(-1081, 74, -20), 0));
		levels.get(17).addButton(new Button(new Vector(-1044, 73, -6), 3));
		levels.get(17).addButton(new Button(new Vector(-1067, 73, -2), 4));
		levels.get(17).addButton(new Button(new Vector(-1089, 81, -2), 5));
		levels.get(17).addButton(new Button(new Vector(-1066, 71, -39), 3, true));

		//Level 19
		levels.get(18).addButton(new Button(new Vector(-1156, 75, -38), 1));
		levels.get(18).addButton(new Button(new Vector(-1185, 75, -23), 2));
		levels.get(18).addButton(new Button(new Vector(-1188, 77, -5), 3));
		levels.get(18).addButton(new Button(new Vector(-1147, 75, 0), 1));
		levels.get(18).addButton(new Button(new Vector(-1177, 80, -45), 3, true));

		//Level 20
		levels.get(19).addButton(new Button(new Vector(-1259, 44, -31), 3));
		levels.get(19).addButton(new Button(new Vector(-1235, 47, 21), 4));
		levels.get(19).addButton(new Button(new Vector(-1291, 43, -9), 3));
		levels.get(19).addButton(new Button(new Vector(-1262, 55, -12), 4));
		levels.get(19).addButton(new Button(new Vector(-1253, 54, -43), 4));
		levels.get(19).addButton(new Button(new Vector(-1280, 62, -11), 3));
		levels.get(19).addButton(new Button(new Vector(-1256, 44, -28), 2));
		levels.get(19).addButton(new Button(new Vector(-1262, 61, -24), 4, true));

		//Level 21
		levels.get(20).addButton(new Button(new Vector(-1368, 59, -50), 3));
		levels.get(20).addButton(new Button(new Vector(-1369, 57, -30), 0));
		levels.get(20).addButton(new Button(new Vector(-1388, 54, -29), 5, true));

		//Level 22
		levels.get(21).addButton(new Button(new Vector(-1457, 64, -42), 5));
		levels.get(21).addButton(new Button(new Vector(-1463, 52, -54), 1));
		levels.get(21).addButton(new Button(new Vector(-1463, 52, -60), 1));
		levels.get(21).addButton(new Button(new Vector(-1452, 61, -56), 1));		
		levels.get(21).addButton(new Button(new Vector(-1441, 71, -45), 4, true));

		//Level 23
		levels.get(22).addButton(new Button(new Vector(-1530, 93, -57), 4));
		levels.get(22).addButton(new Button(new Vector(-1544, 87, -39), 4));
		levels.get(22).addButton(new Button(new Vector(-1530, 89, -26), 1));
		levels.get(22).addButton(new Button(new Vector(-1507, 93, -16), 4, true));

		//Level 24
		levels.get(23).addButton(new Button(new Vector(-1627, 97, -19), 1));
		levels.get(23).addButton(new Button(new Vector(-1638, 83, -10), 0));
		levels.get(23).addButton(new Button(new Vector(-1626, 103, -44), 1));
		levels.get(23).addButton(new Button(new Vector(-1655, 94, -34), 5, true));

		//Level 26
		levels.get(25).addButton(new Button(new Vector(-1785, 99, -23), 3));
		levels.get(25).addButton(new Button(new Vector(-1796, 123, 0), 2));
		levels.get(25).addButton(new Button(new Vector(-1738, 107, -33), 4));
		levels.get(25).addButton(new Button(new Vector(-1738, 95, -17), 4));
		levels.get(25).addButton(new Button(new Vector(-1776, 101, -43), 2, true));
		...
		//Level 17
		levels.get(16).addButton(new Button(new Vector(-1049, 49, -5788), 2));
		levels.get(16).addButton(new Button(new Vector(-1046, 51, -5771), 0));
		levels.get(16).addButton(new Button(new Vector(-1034, 51, -5771), 1));
		levels.get(16).addButton(new Button(new Vector(-1045, 53, -5766), 2, true));
		...
		levels.get(28).addButton(new Button(new Vector(-2048, 79, 2), 4));
