...
static unsigned int gpioLED = 17;       ///< hard coding the LED gpio for this example to GPIO17
static unsigned int gpioButton = 27;    ///< hard coding the button gpio for this example to GPIO27
...
// gpio_set_value(gpioLED, ledOn);          // Not required as set by line above (here for reference)
   ...
   gpio_set_debounce(gpioButton, 2000);      // Debounce the button with a delay of 200ms
